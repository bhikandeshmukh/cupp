...
def print_cow():
    ...
    print(
        "           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ Instagram @bhikan_deshmukh ]"
    )
    print(28 * " " + "[ GitHub @bhikandeshmukh     ]\r\n")
...
def version():
    ...
    print("	* Hacked up by Mr. Bee https://github.com/bhikandeshmukh")
